...
function Homepage() {
    return (
        <div className="relative flex flex-col bg-base-300">
            ...
            <section className="min-h-[calc(100vh-64px)] w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-0 gap-6 lg:gap-10">
