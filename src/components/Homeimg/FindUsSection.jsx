...
function FindUsSection() {
    return (
        <div className="w-full flex justify-center items-center bg-gray-800 p-6 rounded-lg mt-20">
            <div className="w-1/2">
                <iframe
            ...
            <div className="w-1/2 text-white text-center pl-6">
                <h3 className="text-3xl font-bold mb-4">Encontranos en</h3>
