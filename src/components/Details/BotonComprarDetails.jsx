const BotonComprarDetails = () =>{
    ...
    return (
        <div className="join items-center">
            ...
            <button className="btn join-item w-[200px] h-[46px] text-#85BB2F" style={{backgroundColor:"#85BB2F"}}><p className="text-base" style={{color:"#314254"}} >Agregar al Carrito</p></button>
        </div>
    )
