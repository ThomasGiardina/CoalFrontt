...
const InputsRegister = ({ setFormData }) => {
    ...
    return (
        <div className="flex flex-col items-start gap-4" onChange={handleInputChange}> 
            ...
            <label className="input input-bordered flex items-center gap-2 w-[520px]">
                ...
                <input type="text" className="grow" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="Nombre Usuario" />
            </label>
            <label className="input input-bordered flex items-center gap-2 w-[520px]">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="h-4 w-4 opacity-70">
