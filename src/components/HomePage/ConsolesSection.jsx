    ...
    return (
        <div className="w-full flex flex-col items-center mt-20">
            ...
            <div className="w-full flex justify-around mb-20">
                ...
                <Link to={{ pathname: "/store", search: "?filter=playstation" }} className="console-box w-40 h-40">
                ...
                <Link to={{ pathname: "/store", search: "?filter=nintendo" }} className="console-box w-40 h-40">
