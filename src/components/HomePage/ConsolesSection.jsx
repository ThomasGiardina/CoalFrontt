    ...
    return (
        <div className="w-full flex flex-col items-center mt-20">
            ...
            <div className="w-full flex justify-around mb-20">
                <Link to="/tienda?filtro=xbox" className="console-box w-40 h-40">
                ...
                <Link to="/tienda?filtro=playstation" className="console-box w-40 h-40">
                ...
                <Link to="/tienda?filtro=nintendo" className="console-box w-40 h-40">
                ...
                <Link to="/tienda?filtro=pc" className="console-box w-40 h-40">
